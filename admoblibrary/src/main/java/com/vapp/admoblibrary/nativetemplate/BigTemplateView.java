...
package com.vapp.admoblibrary.nativetemplate;
...
public class BigTemplateView extends FrameLayout {
    ...
    public BigTemplateView(Context context) {
        super(context);
    }

    public BigTemplateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public BigTemplateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BigTemplateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
